...
export type ChessPieceRef = {
  moveTo: (square: Square, promotion?: string) => Promise<Move | undefined>;
    ...
    ({ id, startPosition, square, size }, ref) => {
      ...
      const wrappedOnMoveForJSThread = useCallback(
        ({ move }: { move: Move }) => {
          console.log('WRAPPED');
          console.log(move);
          onMove(move.from, move.to, move.promotionPiece);
        },
        [onMove]
      );
          ...
          return new Promise<Move | undefined>((resolve) => {
            ...
            translateY.value = withTiming(
              ...
              (isFinished) => {
                ...
                if (move) {
                  runOnJS(wrappedOnMoveForJSThread)({move: {...move, promotionPiece: promotion}});
      ...
      useImperativeHandle(
        ...
        () => {
          return {
            moveTo: (to: Square, promotion?: string) => {
              console.log('IMPERATIVE')
              console.log(promotion)
              return moveTo(square, to, promotion);
            },
